1 - vamos criar um modal para mostrar o response body
<template>
    <tr>
...
<textarea name="" id=""  :value="check.response_body" readonly class="border-gray-300 rounded-md w-full" rows="10">
